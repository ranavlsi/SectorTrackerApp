...
def run_deepvue_scan():
    ...
    print("[DeepVue Engine] Scanning strict technicals (Anti-Chop) and liquidity...")
    for ticker, group in grouped:
        try:
            ...
            # 2. Anti-Chop: Must have closed > 50 SMA for at least 16 of the last 20 days (80% of the time)
            ...
            # 3. Slope constraint: 200 SMA and 50 SMA must be trending UP over the last month
            ...
            # 4. Proximity to 52-week High (Must be within 25% to filter out "broken" bottom-fishing stocks)
    ...
    print(f"[DeepVue Engine] Found {len(top_candidates)} pristine, non-choppy leaders. Fetching fundamentals...")
    ...
    print(f"[DeepVue Engine] Scan complete. Found {len(final_leaders)} pristine TRUE market leaders. Saved to deepvue_results.json")
