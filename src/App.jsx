...
const ScreenerCategories = {
  ...
  vah_rejection: { title: "Volume Profile: VAH Pullback Support", icon: <RefreshCw color="#f59e0b" />, desc: "Volume Profile: Price pulls back from above to test the Value Area High (VAH) and prints a bullish rejection candle, holding institutional expansion support." },
  poc_rejection: { title: "Volume Profile: POC Pullback Support", icon: <RefreshCw color="#ec4899" />, desc: "Volume Profile: Price pulls back to test the Point of Control (POC) high-volume node and rejects downward continuation, confirming fair value accumulation." },
