  ...
  chop_incubation_leaders: (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
      ...
      <ul style={{ margin: 0, paddingLeft: '20px' }}>
        <li><strong>Rule 1 (Institutional Mega-Liquidity):</strong> 20-day average share volume &ge; <strong>10,000,000 shares/day</strong>, guaranteeing elite institutional liquidity and eliminating mid/small-cap illiquidity.</li>
        <li><strong>Rule 2 (Stage 2 Trend Shield):</strong> Price &gt; 50-day SMA and 50-SMA &gt; 200-SMA, proving the stock holds its moving average floor while the broad market struggles.</li>
        <li><strong>Rule 3 (RS Outperformance):</strong> Relative Strength vs SPY over 3 months is accelerating (&gt; +2% excess alpha), confirming institutional accumulation during index chop.</li>
        <li><strong>Rule 4 (Unbroken Base Shelf / Pre-Breakout):</strong> The 52-week high is strictly <em>unbroken</em>. Price is resting 2% to 22% <em>underneath</em> its ceiling inside an active base, ensuring the stock has not already triggered/broken out.</li>
        <li><strong>Rule 5 (Volume Dry-Up / VDU):</strong> 5-day average volume contracts relative to 50-day average, confirming exhaustion of overhead supply.</li>
        <li><strong>Rule 6 (Guardian MA Defense):</strong> Holds above the stock's backtested institutional Guardian MA (10-SMA, 21-SMA, or 50-SMA) with zero 2-day breakdown character change alerts.</li>
      </ul>
    </div>
  ),
  relative_strength: (
